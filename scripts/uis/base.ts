...
import { guildData, userData } from "../datas/types"
 ...
 */
export function showGuildListUi(player: Player): Promise<guildData | undefined> {
 ...
 */
export function showUserListUi(player: Player, userDatas?: userData[]): Promise<userData | undefined> {
 ...
 */
export function userDataUi(userData: userData): ActionFormData {
    try {
        let guildData: undefined | guildData;
        ...
        switch (userData.authority) {
            case "admin": authority = "관리자"
                break;
            case "subAdmin": authority = "부관리자"
                break;
            case "member": authority = "맴버"
                break;
            case "user": authority = "유저"
                break;
            case "waiting": authority = "가입 대기"
                break;
            default:
                break;
        }
 ...
 */
export function guildDataUi(guildData: guildData): ActionFormData {
    try {
        return new ActionFormData()
            .title("길드")
            .body(`
